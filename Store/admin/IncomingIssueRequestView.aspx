<%@ Page Title="" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="IncomingIssueRequestView.aspx.cs" Inherits="Store_admin_IncomingIssueRequestView" %>

<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    <div id="content" class="box">
        <h1>Incoming Issue Request View</h1>
        <br />
            ...
            <div id="Grid">
                <asp:GridView ID="GridView1" Width="100%" runat="server" Style="text-align: center;" AutoGenerateColumns="false" DataSourceID="SqlDataSource1"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Slip No" ItemStyle-Width="2000px">
                            <ItemStyle Width="0px" />
                            <ItemTemplate>
                                <asp:Label ID="LabelSlip" runat="server" Text='<%# Bind("Slipno") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Depname" ItemStyle-Width="2000px">
                            <ItemStyle Width="200px" />
                            <ItemTemplate>
                                <asp:Label ID="Labeldep2" runat="server" Text='<%# Bind("Depname") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
