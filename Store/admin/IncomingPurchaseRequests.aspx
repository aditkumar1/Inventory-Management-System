    ...
    <div id="content" class="box">
        ...
        <h2>
            <asp:GridView ID="GridView1" runat="server"
                ...
                AllowPaging="true" OnPageIndexChanging="OnPaging" RowStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" PageSize="5">
                <Columns>
        ...
        <h2>&nbsp;<asp:Button ID="Button2" runat="server" Height="50px" OnClick="Button2_Click" Text="View" Width="200px" />
        </h2>
        <br />
        <br />
        <asp:Label ID="Label2" runat="server" Font-Size="Large" Text="Forwarded From Director"></asp:Label>
        <br />
        <br />
        <h2>
            <asp:GridView ID="GridView2" runat="server"
                ...
                AutoGenerateColumns="false" Font-Names="Arial"
                Font-Size="11pt" AlternatingRowStyle-BackColor="#C2D69B" Width="100%"
                AllowPaging="true" OnPageIndexChanging="OnPaging2" RowStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" PageSize="5">
                <Columns>
                    <asp:TemplateField ItemStyle-Width="5%">
                        <ItemTemplate>
                            <asp:RadioButton ID="RadioButton1" GroupName="Grid" runat="server"
                                onclick="RadioCheck2(this,'GridView2');" />
                            <asp:HiddenField ID="HiddenField1" runat="server"
                                Value='<%#Eval("Prno")%>' />
                        </ItemTemplate>
                    </asp:TemplateField>
