...
public partial class Store_Hod_PendingIssueRequest : System.Web.UI.Page
{
    ...
    private void BindGrid()
    {
        ...
        String strQuery = "select DISTINCT (Slipno),Depname,Requester,Designation,Gendate as Sortdate,Convert(varchar(10),CONVERT(date,Gendate,106),103) as Gendate from IssueRequisition where Status='Pending' order by Sortdate DESC";
    ...
    protected void Button1_Click1(object sender, EventArgs e)
    {
        ...
        if (ViewState["SelectedSno"] != null)
        {
            ...
            Response.Redirect("IncomingIssueRequestView.aspx");
        }
    }
}