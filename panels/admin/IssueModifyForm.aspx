<%@ Page Title="" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="IssueModifyForm.aspx.cs" Inherits="ProductEntry" %>
...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    <script>
        function setLabelValue(val1, val2) {
            ...
            $('#ContentPlaceHolder1_Label4').html(val2);
            return false;
        }
    </script>
    <script>
    ...
    <div id="content" class="box">
        <h1>Modify Issue Register<asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server">
        ...
        <table class="nostyle" width="100%">
            ...
            <tr>
                ...
                <td style="height: 50px; width: 453px;">
                    ...
                    <asp:CalendarExtender ID="TextBox9_CalendarExtender" Format="yyyy-MM-dd" runat="server" CssClass="cal_Theme2" Enabled="True" TargetControlID="TextBox9">
        ...
        <!-- Form -->
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Button ID="Button6" runat="server" Text="Reset" Width="250px" OnClick="Button6_Click" Height="40px" CausesValidation="false" />
    </div>
</asp:Content>
