<%@ Page Title="" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="IncomingIssueRequests.aspx.cs" Inherits="Store_Hod_PendingIssueRequest" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">

    <div id="content" class="box">
        <h1>Incoming New Issue Requests</h1>
        <p>&nbsp;</p>
        <!-- Headings -->
        <asp:Label ID="Label7" runat="server" Font-Size="Large" Text="Select an Issue Slip no and Click on View button"></asp:Label>
        <br />
        <br />
        <h2>
            <asp:GridView ID="GridView1" runat="server"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Issue Slip No">
                        <ItemTemplate>
                            <asp:Label ID="Label1" runat="server" Text='<%# Bind("Slipno") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
