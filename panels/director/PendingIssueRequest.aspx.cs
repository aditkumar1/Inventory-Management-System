    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        GetSelectedRecord();
         if (RadioButton3.Checked)
         {
            ...
            string strQuery = "select DISTINCT(Slipno),Status,ApprvRemarks as Remarks,Convert(varchar(10),CONVERT(date,Gendate,106),103) as Date,Gendate as Sortdate from IssueRequisition where Slipno LIKE '%" + TextBox2.Text + "%' and Requester='" + Requester + "' and Depname='" + Depname + "' and Designation='" + Designation + "' Order By Sortdate DESC";
            BindGrid(strQuery);
        }
        if (RadioButton4.Checked)
        {
            ...
            string strQuery = "select DISTINCT(Slipno),Status,ApprvRemarks as Remarks,Convert(varchar(10),CONVERT(date,Gendate,106),103) as Date,Gendate as Sortdate from IssueRequisition Where Gendate BETWEEN '" + TextBox3.Text + "' AND  '" + TextBox4.Text + "' and Requester='" + Requester + "' and Depname='" + Depname + "' and Designation='" + Designation + "' Order By Sortdate DESC";
            BindGrid(strQuery);
        }
    }
