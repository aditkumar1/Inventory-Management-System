<%@ Page Title="" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="PurchaseRequestSlip.aspx.cs" Inherits="Store_ProductEntrySearchSlip" %>
    ...
    <div id="content" class="box">
        ...
        <asp:Panel ID="Panel1" runat="server">
            <table width="100%" height="100%" border="1px">
                ...
                <tr>
                    <td colspan="4" align="center" style="height: 30px">Purchase Request Slip
                    </td>
                </tr>
                <tr>
                 ...
                 <asp:Label ID="Label1" runat="server" Text="*"></asp:Label>
                        <br />
                        Gen. Date:&nbsp;&nbsp;
                 <asp:Label ID="Label9" runat="server" ForeColor="#0000CC" Text="*"></asp:Label>
                        <br />
                        Exp. Delivery Date:&nbsp;&nbsp;
                    ...
                    <td colspan="4" valign="TOP" height="100%">
                        ...
                        <asp:GridView ID="GridView1" runat="server"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="Apprxcost" HeaderText="Approx Cost" ItemStyle-Width="150px">
                                    <ItemStyle Width="150px" />
                                </asp:BoundField>
                            </Columns>
                            <HeaderStyle BackColor="Blue" />
