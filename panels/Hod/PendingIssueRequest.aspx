<%@ Page Title="" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="PendingIssueRequest.aspx.cs" Inherits="Store_Hod_PendingIssueRequest" %>
<%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="asp" %>
<asp:Content ID="Content1" runat="server" contentplaceholderid="ContentPlaceHolder1">
    <div id="content" class="box">
        <h1>Search Issue Request</h1>
      <!-- Headings -->
        <br/>
        <br/>
          <h2>Input The Field To Search And Press Enter</h2>
        <h2><asp:RadioButton ID="RadioButton3" runat="server" GroupName="SearchSelect" Text="Issue Slip No" AutoPostBack="True" Checked="true" />
&nbsp;&nbsp;&nbsp;&nbsp;
      ...
      <!-- Headings -->
        ...
        <h2>
            ...
            <ItemTemplate>
                ...
                <asp:BoundField ItemStyle-Width="150px" DataField="Slipno"
        ...
        <h2>
            &nbsp;<asp:Button ID="Button1" runat="server" Height="50px" OnClick="Button1_Click1" Text="View" Width="200px" />
        </h2>
    </div>
</asp:Content>
